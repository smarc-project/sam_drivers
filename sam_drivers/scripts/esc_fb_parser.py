...
class ESCParser(object):
    ...
    def __init__(self):
        self.esc_subs0 = message_filters.Subscriber("esc_status0_fb", ESCStatus)
        self.esc_subs1 = message_filters.Subscriber("esc_status1_fb", ESCStatus)
        self.esc_pub = rospy.Publisher("rpm_fb", ThrusterRPMs, queue_size=10)
        self.ts = message_filters.ApproximateTimeSynchronizer([self.esc_subs0, self.esc_subs1], 10, slop=1.0, allow_headerless=False)

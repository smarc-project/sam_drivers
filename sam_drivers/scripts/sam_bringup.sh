...
tmux send-keys "roslaunch sam_drivers sam_core.launch"

tmux select-window -t $SESSION:2
tmux send-keys "roslaunch sam_dead_reckoning sam_stim_dr.launch"

tmux select-window -t $SESSION:3
tmux send-keys "roslaunch sam_drivers sam_controllers.launch"

...
public:
    ...
    UavToRosBridge(){
        ...
        uav_node.reset(new Node(getCanDriver(can_interface), getSystemClock()));
        ...
        */
        ...
        uav_to_ros::ConversionServer<uavcan::equipment::power::BatteryInfo, sensor_msgs::BatteryState> battery_server3(*uav_node, pn, "battery_state_basic");
...
int main(int argc, char** argv)
{
    ...
    boost::shared_ptr<UavToRosBridge> bridge(new UavToRosBridge());

...
template <>
bool convert(const std::shared_ptr<sam_msgs::msg::ThrusterAngles> ros_msg, uavcan_equipment_actuator_ArrayCommand& uav_msg, unsigned char uid,DefaultTag)
{
    // std::cout << "Inside Thrust vector convert"<< std::endl;

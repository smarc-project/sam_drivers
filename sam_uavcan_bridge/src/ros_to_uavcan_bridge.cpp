...
public:
    ...
    RosToUavBrigde(){
        ...
        */
        ...
        ros::Timer timer = ros_node.createTimer(ros::Duration(0.1), callback);

        /*
        * Set the node to operational model
        */
...
int main(int argc, char** argv)
{
    ...
    boost::shared_ptr<RosToUavBrigde> bridge(new RosToUavBrigde());
